...
const { TeacherRegistration, TeacherLogin, getReport, VerifyOTP, GetClasses, ForgotPassword, ChangePassword, generateOTP } = require('../controllers/teacher.controller.js');
